...
htmlhelp_basename = 'panel-segmentationdoc'
...
man_pages = [
    (master_doc, 'panel-segmentation', 'panel-segmentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'panel-segmentation', 'panel-segmentation Documentation',
     author, 'panel-segmentation', 'One line description of project.',
     'Miscellaneous'),
]
...
# Execution settings for nbsphinx for juypter notebooks
nbsphinx_execute_arguments = [
    "--InlineBackend.figure_format='svg'",
    "--ignore-glob=*",  # Ignore all warnings
]
